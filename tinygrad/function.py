...
class Sin(Function):
  ...
  def temp(self, x:LazyBuffer) -> LazyBuffer:
    ...
    term = x
    for i in range(14):
      res = res.e(BinaryOps.ADD, term.e(BinaryOps.MUL, x).e(BinaryOps.DIV, x.const(2 * i + 2)).e(BinaryOps.MUL, x).e(BinaryOps.DIV, x.const(2 * i + 3)).e(BinaryOps.MUL, x.const((-1) ** (i % 2))))
